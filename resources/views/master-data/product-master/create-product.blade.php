            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto mt-5">
                        <h2 class="mb-5 text-2x1 font-bold">Create New Product</h2>
                        <x-auth-session-status class="mb-4":status="session(success)" />
                        <form action="{{ route('product-store')}}" method="POST" class="space-y-4">
                            @csrf <!-- Laravel CSRF protevtion -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="type" name="type" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="qty" name="qty" class="block w-full p-2 mt-1 border border-gray-300 rounded-sm shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>

                        ...
                        <form action="{{ route('product-store')}}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <select id="supplier" name="supplier_id"
                                    class="mt-1 block w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm text-black" required>
